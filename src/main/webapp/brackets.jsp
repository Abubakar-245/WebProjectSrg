    ...
    <div class="container">
        <div class="split split-one">
            <div class="round round-one current">
                <div class="round-details">Round 1<br/><span class="date">May 16</span></div>
                <ul class="matchup">
        ...
        <div class="champion">
            <div class="semis-l">
                <div class="round-details">First semifinals <br/><span class="date">May 26-28</span></div>
            ...
            <div class="final">
                ...
                <div class="round-details">championship <br/><span class="date">May 30 - Apr. 1</span></div>
                <ul class ="matchup championship">
                    <li class="team team-top">&nbsp;<span class="vote-count">&nbsp;</span></li>
                    <li class="team team-bottom">&nbsp;<span class="vote-count">&nbsp;</span></li>
                </ul>
            ...
            <div class="semis-r">
                <div class="round-details">Second semifinals <br/><span class="date">May 26-28</span></div>
                <ul class ="matchup championship">
                    <li class="team team-top">&nbsp;<span class="vote-count">&nbsp;</span></li>
                    <li class="team team-bottom">&nbsp;<span class="vote-count">&nbsp;</span></li>
                </ul>
